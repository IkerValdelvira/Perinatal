...
class EducpPredictor(object):

    @staticmethod
    def randomforest_predictor(dataset, output_dir):
        file = open(os.path.join(output_dir, "REPORT_RandomForest_educp.txt"), "w")
        file.write("'educp' feature prediction:\n\n")
        ...
        dataset = dataset.drop(['mimmi', 'fimmi', 'paisnxm', 'paisnxp', 'estudiom', 'estudiop', 'educm', 'conviven'], axis=1)

        # Borrar items con missing values
        dataset = dataset.dropna()

        # Train/Dev split
        labels = dataset['educp']
        data = dataset.drop('educp', axis=1)
        ...
        # Save the model
        joblib.dump(classifier, os.path.join(output_dir, "RF_MODEL_educp.joblib"), compress=3)
        print('[RF] Trained model saved in: ' + os.path.join(output_dir, "RF_MODEL_educp.joblib"))
        ...
        plt.title("Confusion matrix (Dev), 'educp' feature")
        plt.tight_layout()
        plt.savefig(os.path.join(output_dir, "ConfusionMatrix_educp.png"))
        plt.close()
        print('[RF] Confusion matrix saved in: ' + os.path.join(output_dir, "ConfusionMatrix_educp.png"))
        ...
        plt.title("ROC curve (Dev), 'educp' feature")
        plt.legend(loc="lower right")
        plt.savefig(os.path.join(output_dir, "ROCcurve(Dev)_educp.png"))
        print('[RF] Dev ROC curve and AUC saved in: ' + os.path.join(output_dir, "ROCcurve(Dev)_educp.png"))
        plt.close()

        print('[RF] Model evaluation report saved in: ' + os.path.join(output_dir, "REPORT_RandomForest_educp.txt"))
        ...
        fig.tight_layout()
        plt.savefig(os.path.join(output_dir, "FeatureImportanceMDI_educp.png"))
        print('[RF] Feature importance based on mean decrease in impurity saved in: ' + os.path.join(output_dir, "FeatureImportanceMDI_educp.png"))
        plt.close()
    ...
    def dnn_predictor(dataset, output_dir):
        ...
        joblib.dump(scaler, os.path.join(output_dir, 'std_scaler_educp.bin'), compress=True)
        print("[DNN] Standard scaler saved in: " + str(os.path.join(output_dir, 'std_scaler_educp.bin')))
        ...
        file = open(os.path.join(output_dir, "REPORT_DNN_educp.txt"), "w")
        file.write("DNN model: 'educp' feature prediction\n\n")
        ...
        print('[DNN] Trained model saved in: ' + os.path.join(output_dir, "DNN_MODEL_educp.h5"))
        model.save(os.path.join(output_dir, "DNN_MODEL_educp.h5"))
        ...
        plt.savefig(os.path.join(output_dir, "ConfusionMatrix_educp.png"))
        plt.close()
        print('[DNN] Confusion matrix saved in: ' + os.path.join(output_dir, "ConfusionMatrix_educp.png"))
        ...
        plt.legend(loc="lower right")
        plt.savefig(os.path.join(output_dir, "ROCcurve(Dev)_educp.png"))
        print('[DNN] Dev ROC curve and AUC saved in: ' + os.path.join(output_dir, "ROCcurve(Dev)_educp.png"))
        plt.close()

        print('[DNN] Model evaluation report saved in: ' + os.path.join(output_dir, "REPORT_DNN_educp.txt"))
    ...
    def model_comparison(rf_data, dnn_data, output_dir):
        ...
        plt.title("ROC curve (Dev), 'educp' feature")
        plt.legend(loc='best')
        plt.savefig(os.path.join(output_dir, "ROCcurveComparison(Dev)_educp.png"))
        print('\n[Comparison RF/DNN] Dev ROC curve and AUC comparison saved in: ' + os.path.join(output_dir, "ROCcurveComparison(Dev)_educp.png"))
        plt.close()
