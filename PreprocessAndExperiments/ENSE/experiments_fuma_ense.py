...
def split_train_dev_test(dataset, output_dir):
    ...
    dataset = dataset.drop(['IDENTHOGAR', 'PROXY_0', 'PROXY_1', 'PROXY_2', 'PROXY_2b', 'PROXY_3b', 'PROXY_4', 'PROXY_5', 'E2_1c', 'E2_1d', 'F7', 'G25b_2', 'G25c_2', 'G25b_3', 'G25c_3', 'G25b_13', 'G25c_13', 'G25b_19', 'G25c_19', 'G25b_22', 'G25c_22', 'G25b_23', 'G25c_23', 'G25a_30', 'G25b_30', 'G25c_30', 'O73', 'O84_8', 'O84_9', 'P87_3b', 'P87_5b', 'P87_8b', 'P87_9b', 'P87_15b', 'P87_16b', 'P87_17b', 'P87_21b', 'P87_22b', 'U120FZ', 'U120CANTFZ', 'V122', 'V123', 'V124', 'V125', 'V126', 'W128Vermut_1', 'W128Vermut_2', 'W128Vermut_3', 'W128Vermut_4', 'W128Vermut_5', 'W128Vermut_6', 'W128Vermut_7', 'W128Lic_1', 'W128Lic_2', 'W128Lic_3', 'W128Lic_4', 'W128Lic_5', 'W128Lic_6', 'W128Lic_7', 'W128Comb_1', 'W128Comb_2', 'W128Comb_3', 'W128Comb_4', 'W128Comb_5', 'W128Comb_6', 'W128Comb_7', 'W128Sidra_1', 'W128Sidra_2', 'W128Sidra_3', 'W128Sidra_4', 'W128Sidra_5', 'W128Sidra_6', 'W128Sidra_7', 'FACTORADULTO'], 1)
...
def experiment_rf(train, dev, output_dir):
    ...
    file.write("RandomForest model: 'fuma' prediction:\n\n")

    # Features/Labels
    y_train = train['fuma']
    X_train = train.drop('fuma', axis=1)
    feature_names = X_train.columns
    y_dev = dev['fuma']
    X_dev = dev.drop('fuma', axis=1)
    ...
    imputation_dict_file = open(os.path.join(output_dir, "imputation_dict_fuma.json"), "w")
    json.dump(imputation_dict, imputation_dict_file)
    imputation_dict_file.close()
    print("[RF] Missing value imputer saved in: " + str(os.path.join(output_dir, "imputation_dict_fuma.json")))
    ...
    print("[RF] Standard scaler saved in: " + str(os.path.join(output_dir, 'std_scaler_fuma.bin')))
    ...
    train_cor['fuma'] = y_train
    cor = train_cor.corr()
    cor_target_25 = abs(cor["fuma"]).sort_values(ascending=False).head(26)
    cor_features_25 = cor_target_25.index.tolist()
    X_train = train_cor[cor_features_25].drop('fuma', 1)
    cor_features_25.remove('fuma')
    ...
    # Save the model
    joblib.dump(classifier, os.path.join(output_dir, "RF_MODEL_fuma.joblib"), compress=3)
    ...
    plt.title("Confusion matrix (Dev), 'fuma' prediction")
    plt.tight_layout()
    ...
    plt.title("ROC curve (Dev), 'fuma' prediction")
    plt.legend(loc="best")
...
def experiment_dnn(train, dev, output_dir):
    # Features/Labels
    y_train_val = train['fuma']
    X_train_val = train.drop('fuma', axis=1)
    ...
    json.dump(imputation_dict, imputation_dict_file)
    imputation_dict_file.close()
    print("[DNN] Missing value imputer saved in: " + str(os.path.join(output_dir, "imputation_dict_fuma.json")))
    ...
    file.write("DNN model: 'fuma' prediction\n\n")
    ...
    print('[DNN] Trained model saved in: ' + os.path.join(output_dir, "DNN_MODEL_fuma.h5"))
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser( description="Script to perform 'fuma' classification in ENSE dataset. Data is splitted in Train(70%), Dev(15%), Test(15%), and missing value imputation, data standardization and class rebalance (undersampling) is performed. Usage example: $python experiments_fuma_ense.py dataENSE2017_m_fuma.csv -o pathTo/ExperimentsFumam")
    parser.add_argument("input_fuma_dataset",
                        help="Path to file with input ENSE dataset with 'fuma' class. For example: 'dataENSE2017_m_fuma.csv'.")
    ...
    input_fuma_dataset = args['input_fuma_dataset']
    output_dir = args['output_dir']

    print("\nReading ENSE dataset with 'fuma' class from: " + str(input_fuma_dataset))
    dataset_fuma = pd.read_csv(input_fuma_dataset, index_col=0)

    print("\nPerforming Train(70%) / Dev(15%) / Test(15%) split of ENSE dataset with 'fuma' class...")
    Path(os.path.join(output_dir, "Train_Dev_Test")).mkdir(parents=True, exist_ok=True)
    train, dev, test = split_train_dev_test(dataset_fuma, os.path.join(output_dir, "Train_Dev_Test"))

    Path(os.path.join(output_dir, "Results")).mkdir(parents=True, exist_ok=True)
    output_dir = os.path.join(output_dir, "Results")

    print("\nTraining 'fuma' classification models...")
